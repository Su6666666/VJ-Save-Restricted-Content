...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7631851979:AAEnrkQi7vXlqKBstQxEOZ2jSBxaPtOdG5U")

# Your API ID from my.telegram.org
API_ID = int(os.environ.get("API_ID", "39510920"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "a340ca518730a0d245c1e2174a63e162")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "6436766847"))
...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://jiteshsharma533_db_user:DMUDTlCefCi3p6ZV@cluster0.yusxrfv.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_NAME = os.environ.get("DB_NAME", "Save_restricted_1contentbot")
